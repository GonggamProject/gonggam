  ...
  return BottomAppBar(
    child: Container(
      ...
      child: Row(
        ...
        children: [
          IconButton(
            icon: Image.asset("$IMAGE_PATH/bottom_home_icon.png", width: 26, height: 26,),
            onPressed: () {
          ...
          IconButton(
            icon: Image.asset("$IMAGE_PATH/bottom_create_icon.png", width: 26, height: 26,),
            onPressed: () {
              if (groupController != null && groupController!.groups.groups.isNotEmpty) {
                ...
                Alert.alertDialog("책방 생성 또는 참여 후\n감사일기를 작성할 수 있어요.");
              }
            },
          ),
          IconButton(
            icon: Image.asset("$IMAGE_PATH/bottom_my_icon.png", width: 26, height: 26,),
            onPressed: () {
